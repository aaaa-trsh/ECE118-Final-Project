...
//void FindBoundTape(void);
//void AlignToBoundTape(void);
//void FindStartTape(void);
//
///*******************************************************************************
...
//        break;
//   
//   case FIND_START_TAPE: // rotate 180, move forward, and sweep side to side until start tape is found
//        switch (ThisEvent.EventType) {
...
//
//void AlignToBoundTape(void) {
//    PostTopHSM(BOUND_ALIGNED);
//}
//
//void FindStartTape(void) {
//    PostTopHSM(START_TAPE_FOUND);
//}
