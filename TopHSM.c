...
//
//static TopHSMState_t CurrentState = Init; // <- change enum name to match ENUM
...
//uint8_t InitTopeHSM(uint8_t Priority)
//{
//    MyPriority = Priority;
...
//                    break;
//            
//            //run a helper function that aligns the robot incase of drift while on guide tape
//
//        default:
//            break;
//        }
